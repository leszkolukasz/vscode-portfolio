...
const AboutPage = () => {
  return (
    ...
    <div className={styles.container}>
      ...
      <p>Also passionate about math, programming in general, linux and FOSS.</p>
    </div>
    <div className={styles.container}>
      <h3>Activities</h3>
      <ul>
    ...
    <div className={styles.container}>
      <h3>Achievements</h3>
      <ul>
        <li>1st place in the 1st round of the 28th Polish Olympiad in Informatics</li>
        <li>Finalist of the 4th edition of the Jagiellonian Mathematics Tournament</li>
      </ul>
    </div>
    </>
  );
